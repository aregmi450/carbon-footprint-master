window.addEventListener('load', e => {
  ...
  let nepali = {
    ...
    title3: 'नेपालमा C02 EMISSIONS',
    title4: 'क्विज !!! कार्बन डायआक्साइडको बारेमा तपाइँ कसरी जान्नुहुन्छ',
    title5: 'METHANE को स्रोतहरु',
  };
  ...
  let english = {
    ...
    title4: 'QUIZ !!! HOW MUCH YOU KNOW ABOUT CARBON DIOXIDE',
    title5: 'SOURCES OF METHANE ',
  };
